...
public class Utilidades
{
	...
	public static final String INGRESANDOESPECIALIDADESPROFESOR = "ingresando especialidades al profesor";
	...
	public static boolean continuar(String accion)
	{
		String opcion;
		boolean validar = false;
		do
		{
			System.out.print("¿Desea continuar " + accion +"?\n1. Si\n2. No\nIngrese su opcion: ");
			opcion = Utilidades.extracted().nextLine();
			validar = Utilidades.esNumero(opcion);
			if (!validar)
			{
